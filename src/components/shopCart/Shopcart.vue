<template>
  <div class="shopcart">
    ...
    <div class="shopcart-wrapper">
      <div class="content-left">
        ...
        <div class="desc-wrapper">
          ...
          :class="{'highligh':totalCount>0}">{{totalPrice}}</p>
      ...
      <div
        ...
        <div class="list-content" ref="listContent">
          <ul>
            <li
              class="food-item"
              v-for="(food,index) in seleteFoods"
              :key="index"
              >
              <div class="desc-wrapper">
                <div class="desc-left">
    ...
    <div class="shopcart-mask" v-show="listShow" @click="hiddenMask"></div>
